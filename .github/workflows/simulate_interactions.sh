...
echo Refresh
DISPLAY=:99 xdotool sleep 0.5 key "F5" sleep 0.5 key "ctrl+r" sleep 0.5
...
DISPLAY=:99 xdotool mousemove ${coords[0]} ${coords[1]} sleep 0.5 click 1 sleep 2

echo Click on mud-button-text-primary
coords=($(FIND_ELEMENT "class" "mud-button-text-primary"))
DISPLAY=:99 xdotool mousemove ${coords[0]} ${coords[1]} sleep 0.5 click 1 sleep 5

echo Click on Anmelden
coords=($(FIND_ELEMENT "buttontext" "Anmelden"))
DISPLAY=:99 xdotool mousemove ${coords[0]} ${coords[1]} sleep 0.5 click 1 sleep 3
